...
TASK_NAME: str = "pdf2parquet"


@dsl.pipeline(
    name=TASK_NAME + "-ray-pipeline",
    description="Pipeline for multiple pdf2parquet",
)
def pdf2parquet(
    # Ray cluster
    ...
    with dsl.ExitHandler(clean_up_task):
        ...
        execute_job = execute_ray_jobs_op(
            ...
            run_id=run_id,
            additional_params=additional_params,
            # note that the parameters below are specific for PDF2PARQUET transform
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(pdf2parquet, __file__.replace(".py", ".yaml"))
