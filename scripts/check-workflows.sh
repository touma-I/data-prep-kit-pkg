...
KFP_BLACK_LIST="doc_chunk pdf2parquet pii_redactor text_encoder license_select repo_level_ordering header_cleanser fdedup hap rep_removal gneissweb_classification tokenization2arrow"
while [ $# -ne 0 ]; do
   case $1 in
